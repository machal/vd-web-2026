...
assert_grep "$CS_DIST/index.html" 'id="author-profile-heading"' "CS author heading"
assert_grep "$CS_DIST/index.html" 'martin-michalek-home.png' "CS author homepage photo"
assert_grep "$CS_DIST/index.html" 'author-profile' "CS author profile box"
