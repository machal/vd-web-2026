...
7. **Odkazování** – externí nástroje/služby odkazovat u prvního výskytu; vnitřní odkazy na důležité články přirozeně v textu. Odkazy nedávat do citací, figcaption, perexů ani do meta částí. Příručka: absolutní cesty `/prirucka/nazev` (nikdy nepoužívat relativní `.md` cesty – nefungují). Blog/podcast: `/blog/…`, `/podcast/…`.
