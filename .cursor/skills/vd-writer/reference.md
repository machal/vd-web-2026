...
- **content-odkazovani.md** – odkazy u prvního výskytu; anchor = celý název (ne rozsekaný fragment, ne meta); ne do citací a perexů. Ve figcaption povolené (zdroj obrázku/grafu).
