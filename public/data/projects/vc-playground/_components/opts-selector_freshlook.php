...
<div class="opts-selector opts-selector-5-items">
  ...
  -->
    ...
    <ul class="opts-variants-list" id="variants-list">
      <li class="opts-variants-variant" data-value="Amethyst">
        <img src="http://www.vasecocky.cz/images/product-colors/freshlook-colorblends-2-cocky/amethyst.jpg" alt="Amethyst">
        <span class="text">Amethyst</span>
      </li>
      <li class="opts-variants-variant" data-value="Blue">
        <img src="http://www.vasecocky.cz/images/product-colors/freshlook-colorblends-2-cocky/blue.jpg" alt="Blue">
  ...
  -->
      <li class="opts-variants-variant active" data-value="Briliant Blue">
        <img src="http://www.vasecocky.cz/images/product-colors/freshlook-colorblends-2-cocky/true-sapphire.jpg" alt="Briliant Blue">
        <span class="text">Briliant Blue</span>
      </li>                    
      <li class="opts-variants-variant" data-value="Gemstone Green">
        <img src="http://www.vasecocky.cz/images/product-colors/freshlook-colorblends-2-cocky/turquoise.jpg" alt="Gemstone Green">
        <span class="text">Gemstone Green</span>
      </li>
      <li class="opts-variants-variant" data-value="Gray">
        <img src="http://www.vasecocky.cz/images/product-colors/freshlook-colorblends-2-cocky/gray.jpg" alt="Gray">
