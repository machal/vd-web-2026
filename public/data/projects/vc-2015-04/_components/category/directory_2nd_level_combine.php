...
<div class="directory">
  ...
  <div class="directory-group">
    ...
    <div class="directory-group-content">
      ...
      <ul>
        <li><a href="category_2nd_level.php" class="directory-item">Všichni</a>  <span class="directory-divider">–</span></li>
        <li><span class="directory-item">Alcon</span>  <span class="directory-divider">–</span></li>
