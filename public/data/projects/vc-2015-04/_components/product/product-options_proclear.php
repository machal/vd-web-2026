...
<div class="product-options product-options-7-items  <?php echo ($page_name == "Košík")?"product-options-cart":"" ?>">
  ...
  <div class="product-options-first-eye">
    ...
    <div class="product-options-items">
      ...
      <div class="product-options-item product-options-item-1 product-options-count form-group">
        <label for="___">
          Počet&nbsp;balení
        </label>
      ...
      <div class="product-options-item product-options-item-2 form-group">
        <label for="___">
          Dioptrie
        </label>
        <select class="form-control" name="___" id="___">
      ...
      <div class="product-options-item product-options-item-3 form-group">
        <label for="___">
          Zakřivení
        </label>
        <select class="form-control" name="___" id="___">
      ...
      <div class="product-options-item product-options-item-4 form-group">
        <label for="___">
          Adice
        </label>
        <select class="form-control" name="___" id="___">
      ...
      <div class="product-options-item product-options-item-5 form-group">
        <label for="___">
          Cylindr
        </label>
        <select class="form-control" name="___" id="___">
      ...
      <div class="product-options-item product-options-item-6 form-group">
        <label for="___">
          Osa
        </label>
        <select class="form-control" name="___" id="___">
      ...
      <div class="product-options-item product-options-item-7 form-group">
        <label for="___">
          Průměr
        </label>
