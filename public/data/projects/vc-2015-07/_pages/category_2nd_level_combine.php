  ...
  <div class="vc-container vc-container-relative">
    ...
    <div class="vc-row">
      ...
      <div class="vc-category-first-col">
        <h1 class="vc-page-heading">Jednodenní kontaktní čočky Alcon</h1>
      ...
      <div class="vc-category-description">
        ...
        <div class="vc-top-bubble">
          <p>
            Jednodenní kontaktní čočky nabízejí nejzdravější a nejpohodlnější způsob nošení kontaktních čoček. Ráno si
            čočku nasadíte a večer zahodíte, není potřeba žádné speciální péče (čištění, roztoky apod.)
          </p>
