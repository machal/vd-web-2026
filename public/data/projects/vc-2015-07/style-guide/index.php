...
<head>
  ...
  <!--<link href='//fonts.googleapis.com/css?family=Roboto:300,300italic,400,500&amp;subset=latin-ext' rel='stylesheet' type='text/css'>-->
...
<div class="sg-body sg-container vc-container">
...
<script>
  // napln odstavce vsemi znaky (a obcas tam vraz <br>)
  $('.sg-subset-chars').html(subsetChars.replace(/([AaÁÓμ…])/g,"<br>$1"));
</script>
</body>
</html>
