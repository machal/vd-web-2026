...
<div class="directory directory-multiple">
  ...
  <h2 class="directory-heading">
    Čočky podle
    <a class="active" href="#kategorie-typ">typu</a> <span class="directory-divider">–</span>
    <a href="#kategorie-znacky">značek</a> <span class="directory-divider">–</span>
    <a href="#kategorie-vyrobce">výrobce</a>:
  </h2>

  <div class="directory-group first" id="kategorie-typ">
    ...
    <div class="directory-group-content">
      <ul>
        ...
        <li><a href="category_2nd_level.php" class="directory-item" >Kontinuální</a>  <span class="directory-divider">–</span></li>
        <li><a href="category_2nd_level.php" class="directory-item" >Silikon-hydrogelové</a>  <span class="directory-divider">–</span></li>
        <li><a href="category_2nd_level.php" class="directory-item" >Bifokální a multifokální</a>  <span class="directory-divider">–</span></li>
        <li><a href="category_2nd_level.php" class="directory-item" >Roční</a></li>
      </ul>
    </div>
  </div>
