  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="content content-narrower content-centered">
        ...
        <h1>Výchozí formátování typografické základny vycházející z Boostrapu</h1>
          ...
          <form action="http://www.cs.tut.fi/cgi-bin/run/~jkorpela/echo.cgi">
            ...
            <p>
              ...
              <input id="f99" type="submit" name="submit" class="btn btn-primary" value="Just a test">
            </p>

            <p>
              <label for="f0">Reset button:</label>
              <input id="f0" type="reset" name="reset" class="btn btn-default"  value="Reset">
            </p>
          </form>
