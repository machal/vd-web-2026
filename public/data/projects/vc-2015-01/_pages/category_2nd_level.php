...
<div class="page-category">
      ...
      <div class="row">
        ...
        <div class="category-metainfo">
          ...
          <div class="category-directory">
            <?php include("../_components/category/directory_2nd_level.php"); ?>
          </div>
  ...
  <div class="container container-full container-right-glued">
    ...
    <div id="product-items" class="product-items-6-on-row">

      <?php include("../_components/category/product-item_biofinity.php"); ?>
      <?php include("../_components/category/product-item_frequency.php"); ?>
      <?php include("../_components/category/product-item_freshlook.php"); ?>
      <?php include("../_components/category/product-item_proclear.php"); ?>

      <!-- Kotva pro umisteni motivatoru na stredne velkych screenech -->
      <div id="motivator-after-4-products"></div>

      <?php include("../_components/category/product-item_frequency.php"); ?>
      <?php include("../_components/category/product-item_dailies.php"); ?>

      <!-- Umisteni motivatoru na malych screenech -->
      <div id="motivator-after-6-products" class="motivator-container">
        <?php include("../_components/motivator_category.php"); ?>
      </div>

      <?php include("../_components/category/product-item_proclear.php"); ?>
      <?php include("../_components/category/product-item_magiceye.php"); ?>
      <?php include("../_components/category/product-item_frequency.php"); ?>
      <?php include("../_components/category/product-item_biofinity.php"); ?>
      <?php include("../_components/category/product-item_freshlook.php"); ?>
      <?php include("../_components/category/product-item_biofinity.php"); ?>
  ...
  <div class="category-testimonials">
    <?php include("../_components/category-testimonials.php"); ?>
  </div><!-- /.category-testimonials -->
