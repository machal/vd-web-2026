...
var LiveForm = {
	options: {
		...
		errorMessageClass: 'vd-form-error',
...
Nette.initForm = function(form) {
    ...
    var el = $(':submit');
    if (el && el.hasClass('btn-use-loading')) {
      el.addClass('button--loading');
      $(el).closest('p').prepend('<span style="position:absolute;top:0;left:0;width:100%;height:100%;opacity:0.6;z-index:123456"></span>');
    }
	});
