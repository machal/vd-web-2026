---
title: "Vibe Coding: 25 Years of Building Websites, the Last Two Completely Different"
description: "AI-assisted coding democratises building software — and traps anyone who skips engineering thinking. Notes from the hype cycle."
date: 2026-02-10
published: true
pairId: vibe-coding
...
# Vibe Coding: I've Built Websites for 25 Years — the Last Two Months Were Nothing Like It
...
## Swept Off My Feet {#riding-the-wave}
...
The name comes from [Andrej Karpathy](https://x.com/karpathy/status/1886192184808149383?lang=en):
...
My main tool is [Cursor](https://cursor.com/) — an editor built on top of VS Code with AI baked in. There are others: [Windsurf](https://windsurf.com/), [GitHub Copilot](https://github.com/features/copilot), Google's [Antigravity](https://antigravity.codes/) is having a moment, and plenty more. What they share is that the AI understands the context of your project and can actually work inside it.

<figure>
<img src="../dist/images/original/vibe-coding-cursor.jpg" alt="Cursor in Agent mode">
<figcaption markdown="1">
*Cursor's Agent mode is glorious — especially when you keep thinking like an engineer. And the interface is familiar from [VS Code](https://code.visualstudio.com/).*
</figcaption>
</figure>
...
* **Vibe coding** — I don't deal with the code at all. I sit down at Cursor or [Macaly](https://www.macaly.com/), describe what I want, and let it run. This is perfect for prototypes and demos (where you'll throw the code away anyway), simple sites and landing pages, or one-off tools. I also use "vibe coding" as a broader label for this whole space.
...
## Where Do I Start as a Beginner? {#where-to-start}

[Jindra Fáborský](https://www.facebook.com/faborsky/posts/pfbid0tRgVkByRZY8qgVVyGy8asoD2ZA1h7uPcwqjv9czxYFwdYbw13RAQbL6ddsgXUvNwl) sorted this nicely into levels based on project complexity:
...
## Me and Vibing: Four Examples {#four-things-i-built}

Theory is nice, but let's get to what I actually did over the last two months.

### Example one: a prototype of the FrontKon site {#example-frontkon}

On the team behind the [FrontKon](https://www.frontkon.cz/) conference, we're discussing a new website. I have a fairly clear opinion and vision for it. To make it easier to show the team what I mean, I go and build a [prototype](https://machal.github.io/frontkon-2026-prototype/cs/).
...
### Example two: a website for my son {#example-son}

My seventeen-year-old son wants to start his first business with a friend — [cutting reels out of videos](https://clipcut.cz/).
...
### Example three: editing copy in PageSpeed.ONE {#example-pagespeed}
...
### Example four: migrating Vzhůru dolů from PHP to Astro {#example-migration}

For two years I've wanted to ditch the old dev stack on Vzhůru dolů. It runs on outdated PHP and the [Perch](https://grabaperch.com/) CMS, which nobody maintains anymore. There's an old database in there, and the whole thing is so fragile that I was even scared to look at it.
...
In the end, it's done. Two to three days of work in total — still amazing, honestly. It's built on [Astro](https://astro.build/), available on GitHub, and has been live since the end of January.
...
## Developers Out of Work? {#developers-out-of-work}
...
### Two types of developers {#two-types-of-developers}
...
### You have to be a developer, or gradually become one {#you-have-to-be-a-developer}
...
## A Few Concrete Cursor Tips {#cursor-tips}

Let's get to how to squeeze the most out of vibe coding.

### Modes in Cursor {#cursor-modes}
...
* `@Codebase` — searches the whole project, best for complex changes
* `@Files` / `@Folders` — targeted context, saves tokens
* `@Docs` — pull in documentation by URL
...
1. **Decomposition.**
   Don't ask for everything at once. Move in small features and iterations.
2. **Cursor rules.**
   Set up [`.cursor/rules`](https://docs.cursor.com/context/rules) in the project root. A persistent "vibe" setting — e.g. "Write in TypeScript, speak English, use this code style."
3. **Sniper vs. shotgun.**
   For small edits, use `Ctrl+K` (inline edit) instead of rewriting an entire file through the agent.
...
* **[Default (Composer)](https://cursor.com/blog/composer-1-5):** Fast, for everyday work. Enough for me in 80% of cases.
* **[Claude Sonnet](https://www.anthropic.com/claude/sonnet):** Smarter, switch it on when the default gets "stuck in a loop." A killer for text.
* **[Gemini](https://gemini.google/about/):** For working with huge context (the whole repository at once). I switch to it only occasionally.

## Flow Not Found… or Is It There After All? {#flow}
...
## This Is Big, but We Still Need People {#people-still-matter}
...
We need people for meetings, for kitchen conversations, for the whole offline context that's still enormous. For [accountability and security](../guide/ai-saas.md). For decisions that require understanding the broader context of the company and the team.
