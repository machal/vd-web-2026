---
title: "Inbox Zero: How to Escape Email Chaos for Good"
description: "A practical, battle-tested system for clearing your inbox, cutting stress, and staying on top of email without living inside it."
published: true
...
tags:
  ...
  - soft-skills
---
# Inbox Zero: how to escape email chaos
...
## Why email still deserves your respect {#e-mail-vyhody}
...
Email has real strengths. The recipient shouldn't expect an instant reply, so you get time to think. Conversations leave a searchable, permanent record. Email isn't as built for interruption as IM, which makes it far friendlier to [deep work](https://www.vzhurudolu.cz/podcast/75-hluboka-prace). And everyone has an email address — even people who barely use it — which makes it the one truly universal platform.
...
[Inbox Zero](http://www.43folders.com/43-folders-series-inbox-zero) was invented and popularized in the 2000s by [Merlin Mann](http://www.merlinmann.com/), a productivity expert.
...
I've personally used Inbox Zero for about ten years. I'd guess I switched over when [Google Inbox](https://en.wikipedia.org/wiki/Inbox_by_Gmail) arrived — the now-defunct, innovative Gmail alternative that, among other things, catered to Inbox Zero enthusiasts.
...
## How I work and which tools I use {#komunikace}

Before we get into concrete, practical tips, I feel the need to put my version of Inbox Zero into a bit of context.

How do I work? I'm a freelancer; my specialty is [web performance consulting](https://www.vzhurudolu.cz/martin), but the bulk of my work today is more or less management. With three colleagues I run consulting under the [PageSpeed.ONE](https://pagespeed.one/) brand, where we have around fifty clients. As part of another team I help develop a [speed tester](https://pagespeed.one/app/). I also help run a developer community and occasionally write articles or [ebooks](https://www.vzhurudolu.cz/ebooky).
...
## Prerequisite one: dedicated, limited time — say, after lunch {#predpoklad-1}
...
## What about the other prerequisites? You'll want to tweak your email settings {#predpoklad-2}
...
<figcaption markdown="1">
*A clear mind with this on your phone? Where on earth do you switch the thing off?! ([Unsplash](https://unsplash.com/photos/X8ejw0g0C_g))*
</figcaption>
</figure>
...
### Everything in one place {#predpoklad-2-jedno}
...
### Reasonable email length {#predpoklad-2-delka}
...
I try to hold the line on my own side too. I like methods, or rather descriptions of the ideal email, like [Five.sentenc.es](http://five.sentenc.es/). Try to cram everything into five sentences. It won't always work, but it's a great exercise in brevity. For less experienced writers, it's worth learning the [Five Ws method](https://www.intercom.com/blog/how-to-send-the-perfect-message-with-the-five-ws/).
