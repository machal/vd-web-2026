---
title: "On Writing: How to Start and Never Stop"
description: "A practical, motivational guide to building a writing habit, beating blank-page fear, and getting into flow — from someone who's written for 30 years."
published: true
pairId: writing
author: Martin Michálek
adaptedFrom:
  title: "O psaní: jak začít a už se nezastavit"
  url: "https://www.vzhurudolu.cz/prirucka/psani"
tags:
  - writing
  - content-creation
  - soft-skills
  - productivity
---
# On writing: how to start and never stop
...
You already have things to write about. Everyone does. The subject is you, your life, your friends, your family, your work. Something happens every day, and if you want it to, every day teaches you something. You can even get a [story](https://www.linkedin.com/posts/martinmichalek_dejte-si-na-sv%C3%A9-v%C4%9Bci-pozor-a-poctiv%C4%9B-z%C3%A1lohujte-activity-7161265988494090240-GqBm/) out of an ordinary trip across town.
...
Yes, you do have to actually do the thing you're writing about. If you want to [write about web development](https://www.vzhurudolu.cz/), you can't know nothing about it. But thanks to writing, within a few hours you'll become noticeably better at it than most other people.

### Sharing knowledge and building a reputation {#reputation}
...
## Can you write too? {#can-you-write}
...
### "I was bad at it in school" {#school}
...
### "It won't be good, people will criticize me" {#criticism}
...
Let me tell you something. I've written a lot. Every week I write something for social media, and almost every week a longer piece. I've written [four books](https://www.vzhurudolu.cz/ebooky). I've had a lot of reactions, and sometimes they genuinely thrill me.
...
### "I don't know what to write about" {#topic}
...
### "Writing is torture for me" {#torture}

I once [wrote](https://x.com/machal/status/1805695060639728124) on X:

> To remind myself how painful writing an article is for some people, I decided to fix my bike myself. "I'll have it done in half an hour."
> Most of Sunday gone. The bike is more broken than before. Now I'm looking for a repair shop.
...
### "Isn't writing obsolete by now?" {#obsolete}
...
I write more about working with AI on both code and text in [Vibe Coding: I've built websites for 25 years, but the last two months were completely different](../guide/vibe-coding.md).
...
### The curse of the blank page {#blank-page}
...
### Structure: put the important stuff up top, ask "why?" {#structure}
...
First, write down the main idea — or at least what the article is about, or some surprising thing you discovered. That has to be in the headline or the first paragraph. It's called the [inverted pyramid](https://en.wikipedia.org/wiki/Inverted_pyramid_(journalism)).
...
### Short, punchy, with verbs, the way you speak {#form}
...
### You won't get far without feedback {#feedback}
...
My friend [Ondřej Ilinčev](https://www.ilincev.com/), who has written for a long time and writes brilliantly, got started by emailing his articles to just a few clients at a time.

Another partner of mine, [Robin Pokorný](https://robinpokorny.com/), writes among other places on his employer's internal blog.
...
If you dare to venture a bit further out, try social media. On [Facebook](https://www.facebook.com/machal) and [LinkedIn](https://www.linkedin.com/in/martinmichalek/), for instance, you can write longer pieces. Pieces of just a few paragraphs work great.

Mastery in honing the core of an idea is offered by [X](https://x.com/machal) and its post-length limit.
...
### Tools and skills: above all, learn to touch-type {#tools-skills}

Tools are overrated. But if you want, I'll mention the ones I use:

- In [Evernote](https://evernote.com/) (a notes database) I log ideas for pieces. I gradually flesh them out and add to them. When I learn something interesting about a topic, I add a link to that topic's page in Evernote. Then when I finally write it up, it's prepared and I don't have to do as detailed a research pass. I also often write the first drafts of my texts in Evernote.
- I move texts from Evernote into [Google Docs](https://workspace.google.com/products/docs/) when I need feedback from other people. The collaboration features in Google Docs are indispensable.
- I use [ChatGPT](https://openai.com/chatgpt/) as a writing assistant. It helps me do research and build structures. It gives me content feedback on my texts. It already does a lot of things brilliantly, though it doesn't yet catch all my language mistakes.
- I store texts in [Markdown](https://www.markdownguide.org/). It's a format that's excellent for searching back through and editing. All my articles are in Markdown, all the chapters of all my books too. I can search back through Markdown when I want to add a link to a topic or edit something retroactively. Like deleting Internet Explorer from every text. That's a joy.
- To make sure I'm writing well, I use grammar checkers and occasionally just a search engine. It's a shame to kill a piece with visible mistakes in it. A certain portion of readers is sensitive to that. I also watch out for [correct typographic characters](https://practicaltypography.com/). Readers will forgive the odd mistake, but there can't be too many of them.
