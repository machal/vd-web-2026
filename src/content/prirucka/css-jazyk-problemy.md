...
To, že každý selektor platí globálně, byl svého času první argument pro používání [CSS v JS.](/podcast/css-v-js)  Vlastně jsem mu ale nikdy úplně plně nerozumněl, hlavně omílanému srovnání s globálními konstantami v programovacích jazycích. 
