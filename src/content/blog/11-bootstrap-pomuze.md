...
og_title: 'Kdy vám Bootstrap pomůže a kdy ne?'
og_description: 'Užitečnost nových technologií bývá částí lidí podceňována, části přeceňována. Zkusím nás tímto článkem zařadit do třetí skupiny, která se k frontend frameworkům staví střízlivě.'
og_type: article
---
...
Vy pokročijejší víte, že Boostrap nemusíte využívat jako celek. Vytáhnete si z něj třeba jen [karusel](http://getbootstrap.com/javascript/#carousel) a… profit! Nebo [formuláře](http://getbootstrap.com/css/#forms), ty jsou samy o sobě dost velký pomocník. Nebo jakoukoliv jinou [komponentu](http://getbootstrap.com/components/). Vítané ušetření práce, i když Bootstrap jako celek nemusíte.

## Nepomůže 

[Wow-efekt](https://www.apple.com/mac-pro/) [prezentační](http://sugarblogfilm.com/en/) weby. Cokoliv příliš organického a málo modulárního, příliš grafického a málo nativního, příliš košatého a málo minimalistického. Rozumíme si? 
...
Bootstrap zásadně pomůže pokud s responzivním webdesignem začínáte. I těm zkušenějším může pomoci s layoutem nebo responzivními komponentámi — vezměme třeba [navigaci](http://getbootstrap.com/components/#navbar). Nasadíte ji a techniku přizpůsobování malým či velkým displejům nemusíta řešit.

Tady jeho pomoc končí. Nijak neřeší rychlost načítání, potřebu nastavovat [breakpointy na míru](http://kratce.vzhurudolu.cz/post/46416507703/jake-breakpointy-zvolit-v-responzivnim-webdesignu) konkrétního obsahu nebo načítání [různé verze komponent](http://foundation.zurb.com/docs/components/interchange.html) podle velikosti displeje. 
...
Využití Bootstrapu u prezentačních webů [je možné](http://expo.getbootstrap.com/), ale nelze dělat *z vůle* (klienta, grafika, kódera, Boha…). 
