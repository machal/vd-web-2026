...
# Vzhůru do práce: představuji agregátor pracovních nabídek pro webové vývojáře
...
- Inzeráty už umístěné na [StartupJobs.cz](http://www.startupjobs.cz/) se zobrazují automaticky.
...
## Pomozte mi jej rozšířit

Aby se malý agregátorek zvětšoval, potřebuji informaci o něm dostat k lidem, kteří mají ve vaší firmě na starosti hledání webových vývojářů. Majitelé, šéfové vývoje, HR lidé… Pomůžete mi? Úplně stačí, když by se k nim dostal tenhle článek a  tato adresa: [http://www.vzhurudolu.cz/prace/info](http://www.vzhurudolu.cz/prace/info).  
Za pomoc díky!

<p class="text-center">Takže…</p>
