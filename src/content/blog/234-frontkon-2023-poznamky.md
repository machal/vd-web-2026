...
og_title: 'Poznámky k programu komunitních konferencí (po FrontKonu 2023)'
og_description: 'Byl to mazec, bylo to velké a troufám si říct, že se to celé povedlo. Zde se ovšem také nahlas zamýšlím, co příště udělat jinak.'
og_type: article
---

# Poznámky k programu komunitních konferencí (po FrontKonu 2023)

[FrontKon 2023](https://frontendisti.cz/konference) byla první pořádná konference, do které jsme se v rámci komunity [Frontendisti.cz](http://frontendisti.cz/) pustili. Byl to mazec, bylo to velké a přes všechny nedostatky si troufám říct, že se to celé povedlo.
...
![FrontKon 2023: Michálek přednáší](https://res.cloudinary.com/vzhurudolu-cz/image/upload/v1699859304/f%C5%95ontendisti/frontkon-23-001_wwypjj.jpg)
...
## Hektické tempo a krátké přednášky {#tempo}
...
Prosadil jsem narvaný program, pod vlivem skvělého [bratislavského CodeConu](https://www.codecon.sk/). Výhoda takového konceptu je lineup nacpaný zajímavým obsahem. Program tam letí na více místech vpřed a v takovém tempu, že dopředu víte, že to všechno nemáte šanci stihnout.
...
Vše jste neměli stihnout ani na FrontKonu, my jsme to věděli a z výše uvedených důvodů jsme to akceptovali. Většina [přednášek je už ale na YouTube](https://www.youtube.com/@FrontendistiCz/playlists?view=50&sort=dd&shelf_id=3), zdarma k dispozici všem, i těm, kteří nestíhali.

![FrontKon 2023: Grudl přednáší](https://res.cloudinary.com/vzhurudolu-cz/image/upload/v1699859304/f%C5%95ontendisti/frontkon-23-004_vwnueb.jpg)
...
Zpátky k tématům, které jsme v přednáškách a diskuzích akcentovali. Už v [call for papers](https://docs.google.com/document/d/1L-p10YbVE18yOV7EIAbO5VeIBzVV26UJ6E81ecHuuCI/edit#heading=h.324can1sezkl) jsme některé témata zvedli a řada lidí nám poslala a pak odpřednášela zajímavé příspěvky k nim.

Myslím, že konference by měla zvedat (ale ne tlačit) určité otázky. Osobně jsem to před letošním FrontKonem viděl takhle:

* Taháky, které má komunita ráda. Sem letos zapadlo AI a jeho vliv na naši práci. Podívejte se na přednášky [Hany Klingové](https://www.youtube.com/watch?v=YHIMfshpY-U) nebo [Honzy Sládka](https://www.youtube.com/watch?v=WUQahQNxe0E).
* Kritický pohled na aktuální stav. Jít proti srsti považuji za nutnost, jinak se oborově zacyklujeme v sebechvále a obdivu myšlenek aktuálních světových vývojářských celebrit. Letos to schytal aktuální stav JS frameworků, trošku React a Next.js, ale vzali jsme to pozitivně a to pokusem odpovědi na otázku, zda to jde jinak a zda vidíme alternativy. Podívejte se na přednášky [Borka Bernarda](https://www.youtube.com/watch?v=3NdrqcB8da8), [Libora Vaňka](https://www.youtube.com/watch?v=MmDo_RVI2Dw), diskuzi o [JS frameworcích](https://www.youtube.com/watch?v=OrpfxnWGoJY).
* Důležitá témata mimo hlavní proud. Je zde obsah, který není v mainstreamu zase tak moc diskutovaný, ale zaslouží si tu pozornost. Letos to bylo téma juniorů a jejich najímání, v přednáškách například [Yablka](https://www.youtube.com/watch?v=PMpGKZmjvck), [Honzy Javorka](https://www.youtube.com/watch?v=DuqePE3982c) nebo v [diskuzi](https://www.youtube.com/watch?v=Rsg9Lw-Zks8).
...
![FrontKon 2023: diskuze o JS frameworcích](https://res.cloudinary.com/vzhurudolu-cz/image/upload/v1699859304/f%C5%95ontendisti/frontkon-23-006_mws2bq.jpg)

Diskuze se nám osvědčily už na online [FrontKonu 2021](https://www.vzhurudolu.cz/blog/200-frontkon-ohlednuti), takže pokud FrontKon bude pokračovat, budeme na nich více stavět.

Poslední věc, která se mi zdá dobrá, i když netvoří hlavní oblast zájmu, jsou „vsuvky odjinud“. Letos to byl [standup od Pavla Tomeše](https://paveltomes.com/), u kterého jsem se fakt hodně nasmál.
...
![FrontKon 2023: holky](https://res.cloudinary.com/vzhurudolu-cz/image/upload/v1699859305/f%C5%95ontendisti/frontkon-23-002_eqwbnm.jpg)

Myslím si, že ženy do IT patří. Myslím si, že je skvělé, že si cestu k webařině nacházejí stále ve větším počtu a že se snad brzy dočkáme lepšího než nejhoršího stavu v EU, nyní jich máme [kolem 10 %](https://www.seznamzpravy.cz/clanek/ekonomika-byznys-rozhovory-zen-je-v-it-malo-pro-uplatneni-pritom-neni-nutne-technicke-vzdelani-214991).
...
Ve [komunitě Frontedisti.cz](http://frontedisti.cz/) se dlouhodobě snažíme konkrétní holky z oboru vytipovávat, oslovovat a pak s nimi udržovat kontakt, případně odstraňovat bariéry, které u přednášení mohou mít. Začali jsme to cíleně dělat před pár lety a hned to neslo ovoce.

Jakmile byly holky přednášející vidět u Frontendistů na pódiu, padaly bariéry u dalších žen, takže do call for papers pro letošní FrontKon už dorazilo docela dost nabídek k přednášení od holek. Hrálo také roli, že přispěly [sesterské ReactGirls](https://reactgirls.com/), které v transformaci žen do IT dělají spolu s Czechitas výbornou práci.
...
## Zúročení dlouhodobé práce {#zuroceni}
...
![FrontKon 2023: DJ](https://res.cloudinary.com/vzhurudolu-cz/image/upload/v1699859305/f%C5%95ontendisti/frontkon-23-003_dosnyl.jpg)
...
## Chybička se vloudí a to vždy {#chybicka}

Jakkoliv to zvenčí mohlo vypadat docela dobře, uvnitř jsme si prošli malou krizí.

Někteří kritičtější kolegové odjinud nám občas říkají, že [Frontendisti.cz](http://frontendisti.cz/) jsou řízení jako firma, ne jako komunita. Vždy říkám, že ano, platí to v tom pozitivním směru relativně dobrého vedení vedoucího k dlouhodobé udržitelnosti.
...
![FrontKon 2023: lidé](https://res.cloudinary.com/vzhurudolu-cz/image/upload/v1699859305/f%C5%95ontendisti/frontkon-23-005_ofh7m8.jpg)
...
![FrontKon 2023: všichni](https://res.cloudinary.com/vzhurudolu-cz/image/upload/v1699859304/f%C5%95ontendisti/frontkon-23-007_rhot82.jpg)

Díky [Janě Nečasové](https://www.linkedin.com/in/ACoAACPJzqABtEhQZaPa2y7niKJdfPDfAdzm3OM), [Tomášovi Hejčovi](https://www.linkedin.com/in/ACoAAApiv84BTuYd1S00fF-Ksakrh9eN63zdmNQ), [Břetislavu Proftovi](https://www.linkedin.com/in/ACoAAAv0spEBWEdhrJRATL81C8AmgMXNciBBThI), [Kateřině N. Volákové](https://www.linkedin.com/in/ACoAACJRs08B-86s_BZ86Z726PUlHKgOgK35-NI), se kterými jsme to dlouhé měsíce připravovali.

Díky všem ostatním ze štábu konference, jmenovitě hlavně směrem k [Tomášovi Koutovi](https://www.linkedin.com/in/ACoAACxpHwEB_RwLQyNFH47eaRYq_nPGz1uUvBs), [Adině Foxové](https://www.linkedin.com/in/ACoAAB-dm4UBphpPt0M3o_HcoFhUNSFgam6yIyY), [Karolíně Vyskočilové](https://www.linkedin.com/in/ACoAAC3vV8EBJetkoyjxk8WIyRZSESlMQYSxcgQ), [Adamovi Kudrnovi](https://www.linkedin.com/in/ACoAAAHqWLoBM-qTSe5hWexj89cw5khOtlsTb7Y), [Zuzaně Šumlanské](https://www.linkedin.com/in/ACoAABWWHkMB_7arjnTmAYyn6oLYd0FHoJ5T-SA) a dalším.
