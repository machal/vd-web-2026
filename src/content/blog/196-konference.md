...
og_title: '#FrontKon: První česká frontendová konference'
og_description: 'Ve štábu spolku Frontendisti.cz organizujeme první českou frontendovou konferenci a zhmotňujeme tak něco, o čem už dlouhá léta mluvíme.'
og_type: article
---

# #FrontKon: První česká frontendová konference
...
<div class="rwd-media">
  <video muted controls width="1600" height="900">
    <source src="https://res.cloudinary.com/vzhurudolu-cz/video/upload/v1620793094/vzhurudolu-video/Front_Konference_video_nmhrgq.mp4"
      type="video/mp4">
  </video>
</div>
...
* [Zuzana Šumlanská](https://www.linkedin.com/in/zuzana-sumlanska/?originalSubdomain=cz) z [PageSpeed.ONE](https://pagespeed.one/) připravuje přednášku o **častých chybách, které kazí Web Vitals**.
...
**Těším se, že se uvidíme → [https://frontendisti.cz/konference](https://frontendisti.cz/konference).**