...
*Obrázek: U některých webů si přechodu na Lighthouse šestku ničeho nevšimnete, u jiných nastal nemalý sešup ve skóringu. Zdroj: [PageSpeed.ONE](https://pagespeed.one/).*
</figcaption>
</figure>
...
Výsledky pro LPS (Lighthouse Performance Score) verze 6 už vrací náš [nástroj PageSpeed.ONE](https://pagespeed.one/).
