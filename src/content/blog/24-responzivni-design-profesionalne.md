---
postID: 24
postTitle: 'Tim Kadlec: Responzivní design profesionálně - recenze českého vydání'
postUrlId: responzivni-design-profesionalne
postDateTime: '2014-08-19 00:00:00'
excerpt: 'V originále s drobnými výhradami výborný text. V češtině výrazně zabugovaná knížka. I tak vám ale doporučím si ji koupit. Je to totiž první a zatím jediná česká publikace o responzivním webdesignu.'
...
V originále s drobnými výhradami výborný text. V češtině výrazně zabugovaná knížka. I tak vám ale doporučím si ji koupit. Je to totiž první a zatím jediná česká publikace o responzivním webdesignu.
...
Autor originálu, [Tim Kadlec](http://timkadlec.com/) sice v responzivním světě není bůhvíjaká celebrita, pokud se něj ale podíváte v rámci kategorie *rychlost načítání responzivních webů*, je to moc důležitý hlas. O to hezčí je, že tak specializovaný borec napsal dodnes nejucelenější text o responzivním webdesignu. 

Ano, chci tím říct, že ať už to ZonerPress udělal úmyslně nebo jako boční projev nějakých  smluv s New Riders, je skvělé, že v češtině vychází právě [Implementing Responsive Design](http://www.implementingresponsivedesign.com/).

Autor se v ní kromě technických základů responzivního layoutu pustil například také do:
...
Nezapomněl ani na argumentaci pro šéfy a klienty nebo svůj názor kam to půjde do budoucna. 
...
Na oltář širokého záběru bylo v textu obětováno například SVG, výborný formát pro vektorovou grafiku – ikony, logotypy, který řeší přítomnost vysokokapacitních displejů a který Tim Kadlec odbude docela stručně. Nanajdete tady ani aktuální materiál o responzivních obrázcích, ale to vysvětlím později.
...
Však víte, jak to je s technickými knihami. Jsou zastaralé už v tiskárně. 10 let staré knihy o webdesignu – to je [Dikobraz](https://www.google.cz/search?q=Dikobraz&es_sm=91&source=lnms&tbm=isch&sa=X&ei=02HfU_ecJvTT7AbL94GYDQ&ved=0CAgQ_AUoAQ&biw=1920&bih=1102#q=Dikobraz+%C4%8Dasopis&tbm=isch) dnešní doby.
...
Malá zrada — knížka pojednává o [adaptivním, nikoliv responzivním webdesignu](http://www.vzhurudolu.cz/blog/23-adaptivni-responzivni). 
...
Já vím. Překládat odborné publikace z angličtiny do češtiny je nevděčná práce. Jsou hold pojmy, které když přeložíte, naštvete půlku čtenářů a když ne, naštvete druhou půlku. Fakt prima práce, co? 
...
* „Vertikální mediální dotazy", jsou v originále „Vertical Media Queries”. Pochopil bych, když by polovina českých vývojářů rozuměla *mediálním dotazům* a druhá polovina *Media Queries*. Jenže ona ta [mediálně dotazovací polovina](https://www.google.cz/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=%22medi%C3%A1ln%C3%AD+dotazy%22) tvoří redakci ZonerPressu.
* „RESS v divočině" zase v originále zní… Ano „RESS [in the wild](http://www.phrasemix.com/phrases/out-in-the-wild)”! Pokud mě nechápete, je to doslovně přeložená fráze. Tomu bude v češtině někdo rozumět? 
* „Prosazujte responzivní design" je v originálním znění „Selling Responsive Design” a Brad Frost v něm ukazuje jak responzivní design prodává klientům, kteří mají nějaké pochybnosti. Tedy „Jak prodávat responzivní design”. V originále jeden z neužitečnějších textů knihy, překlad z Brada udělal trochu *bullshiteriéra*.
...
* Čtete jen česky a nevadí vám chyby ZonerPressu a lyrické pindy autora? [Kupte si to](http://www.zonerpress.cz/responzivni-design-profesionalne). Je to jediná česká kniha o responzivním webdesignu a odborně je výborná.
* Čtete anglicky a nevadí vám vyšší cena nebo ebook? [Kupte si originál](http://www.implementingresponsivedesign.com/).