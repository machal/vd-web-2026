---
postID: 202
postTitle: 'UX pro vývojáře: pokročilé techniky'
postUrlId: ux-pokrocile
postDateTime: 2021-08-04
excerpt: 'Pokročilejší UX postupy, které jsou obsahem tohoto článku, vám pomohou s řešením komplikovaných problémů. Abyste je použili, musíte překročit svou komfortní zónu. Někdy vyžadují soft skills, někdy prostou zvídavost.'
...
Každý vývojář se může naučit základy práce UXáků, které z něj udělají lepšího vývojáře.
Hodnota takových lidí na trhu práce pak rapidně roste.

## 1) Zadání (získejte dobré zadání) {#zadani}
...
<img src="https://res.cloudinary.com/vzhurudolu-cz/image/upload/v1627904383/vzhurudolu-blog/marek-cevelicek-ux-tip/ux-2-zadani_pw5arm.jpg" width="1920" height="1280" alt="Empty Post-its – Photo by Kelly Sikkema on Unsplash">

Kvalitní zadání něco stojí. Je v pořádku vyhradit si na něj čas a nacenit jej.

Když něco nedává smysl, musíte se ptát. (Přečtěte si knihu [Začněte s proč](https://www.databazeknih.cz/knihy/zacnete-s-proc-172655) od Simona Sineka.)
...
U nás v [Liquid Design](https://www.lqd.cz/) jsme několikrát v průběhu návrhu pořádali tzv. technická kolečka. Designér vzal svůj návrh a prezentoval jej vývojářům. Oni se doptávali podrobněji na funkčnost a dávali designérovi technickou zpětnou vazbu na složitost řešení.
...
## 3) Nespěchejte s řešením {#nespechejte}
...
Uživatelé se zkrátka chovají zvláštně. (Přečtěte si knihu: [Jak drahé je zdarma](https://www.databazeknih.cz/knihy/jak-drahe-je-zdarma-116947) od Dana Arielyho)

Cílem je, aby bylo ovládání aplikace předvídatelné. Vyhovte jim.

## 5) Analogie z reálného světa {#analogie}

Svět kolem nás poskytuje hromadu nápadů na řešení, které všichni dobře známe.
Každý den je máme na očích. Nepřemýšlíte nad nimi. Jsou známé. Jsou jasné.
...
<figure>
<img src="https://res.cloudinary.com/vzhurudolu-cz/image/upload/v1627904915/vzhurudolu-blog/marek-cevelicek-ux-tip/ux-2-good-ui_kz1vjr.png" width="2424" height="1562">
<figcaption markdown="1">
Nahraďte karusel statickými obrázky. Jeden z návrhových vzorů z [GoodUI.com](https://goodui.org/patterns/104/).
</figcaption>
</figure>
...
- [ui-patterns.com/patterns](http://ui-patterns.com/patterns)
- [checklist.design](https://www.checklist.design/)
- [reallygoodux.io/categories](https://www.reallygoodux.io/categories)
- [smileycat.com/category/elements-of-design](https://www.smileycat.com/category/elements-of-design/)

## 7) Kopírujte {#kopirujte}
...
Spousta vychytaných věcí vznikla tak, že designér vzal naprosto běžnou věc a vylepšil na ní drobnost. A nápady na vylepšení vyjdou často najevo z uživatelského výzkumu a patří tam i pozorování (viz [bod 4](#pozorujte)).

## 8) Netlačte na lidi

Nechte pracovat uživatele v tempu, jaké sám chce — vyhněte se automatickému spouštění čehokoliv, co uživatel nemá pod kontrolou. Žádné [automatické karusely](https://www.vzhurudolu.cz/blog/47-znicit-mobilistu-1#2-dejte-tam-karusely-hodne-karuselu).
...
## 9) Buďte vždy konzistentní {#konzistentni}
...
Vytvořte si pravidla pro pojmenování funkcí.
Vycházejte ze slovníku, který je ve vašem odvětví standardní.

## 10) Nejdřív to důležité {#dulezite}
...
I v tomto případě platí [Paretovo pravidlo 80/20](https://cs.wikipedia.org/wiki/Paret%C5%AFv_princip) — 80 % času lidé používají jen 20 % funkcí programu. Zjistěte, které to jsou.

[Běžný Franta uživatel](https://cs.wikipedia.org/wiki/BFU) není zrovna geek. Nemá rád sekci nastavení, chce jednoduchý program a dá vám palec nahoru, když mu zobrazíte jen to, co právě potřebuje. Chce si vyřídit povinnosti a program zavřít. Franta je lenoch.

## 11) Dekorace pryč {#dekorace}
...
Když ve vašem [vývojářském týmu chybí designér](https://www.lqd.cz/ux-designér-brno-praha), není to nikdy dlouhodobě udržitelný vývoj a jednou bude potřeba udělat radikální zásah, který bývá náročný.
...
Jenom když překročíte práh kanceláře, naučíte se něco víc o svých uživatelích. 
Každý krok na místo, kam ostatní už jít nechtějí, z vás udělá lepšího vývojáře.

## Bonus: Rozhodujte líp

Abyste mohli rozhodnout o postupu, musíte pochopit problém. Pro klasifikaci problémů existuje velmi jednoduchý framework [CYNEFIN](https://en.wikipedia.org/wiki/Cynefin_framework) (Dave Snowden, IBM), [Youtube](https://www.youtube.com/watch?v=N7oz366X0-8)).

<img src="https://res.cloudinary.com/vzhurudolu-cz/image/upload/v1627903768/vzhurudolu-blog/marek-cevelicek-ux-tip/ux-2-cynefin_n6ukhb.png" width="1704" height="1772" alt="Cynefin">
