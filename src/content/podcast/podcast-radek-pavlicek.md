...
sectionID: 1
no_ads: false
og_title: 'Podcast: S Radkem Pavlíčkem o přístupnosti aneb inkluzivním designu'
og_description: 'S Radkem jsme letos pro Webexpo připravili dvojblok přenášek o přístupnosti. V předvečer akce jsme si sedli do kavárny a natočili rozhovor. O přístupnosti. Nebo o inkluzivním designu, protože se shodujeme, že pojem přístupnost je všechno jen ne dokonalý.'
og_type: article
---

# Podcast: S Radkem Pavlíčkem o přístupnosti aneb inkluzivním designu

S Radkem jsme letos pro Webexpo připravili [dvojblok přenášek o přístupnosti](http://poslepu.cz/pristupnost-na-webexpo-2017/). V předvečer akce jsme si sedli do kavárny a natočili rozhovor. O přístupnosti. Nebo o inkluzivním designu, protože se shodujeme, že pojem přístupnost je všechno jen ne dokonalý. 

Dozvíte se, že přístupnost je i pro vás. Jak s ní začít, jak argumentovat šéfům a spoustu dalšího. Pojďme na to.

<p class="podcast">
Podcast: <a href="https://soundcloud.com/vzhurudolu/s-radkem-pavlickem-o-pristupnosti" data-id="346570142">S Radkem Pavlíčkem o přístupnosti aneb inkluzivním designu</a>
</p>

## Radek Pavlíček {#radek}
...
* Je přístupnost jen pro slabozraké? ([text](#slabozraci))
* Přístupnost, inkluzivní design nebo universal learning design? ([text](#inkluze))
* Jaké skupiny lidí přístupnost využijí a kolik stojí? ([text](#skupiny))
* Nesmí se zapomenout na přístupnost dokumentů ([text](#dokumenty))
* Co když šéfové přístupnost platit nechtějí? ([text](#sefove))
* Přístupnost řešená po vzniku projektu ([text](#pozde))
* Jak do toho konečně „šlápnout“? ([text](#slapnout))
...
### Je přístupnost jen pro slabozraké? {#slabozraci}
...
**Radek Pavlíček**: Bohužel to pasé není a je to vlastně jedno z témat [přednášky na ](https://www.webexpo.cz/praha2017/prednaska/jak-a-proc-resi-velke-weby-pristupnost/)[WebExpo](https://www.webexpo.cz/praha2017/prednaska/jak-a-proc-resi-velke-weby-pristupnost/), na níž budu přesně o tomto tématu hovořit. Když bych to vzal trošku zeširoka: Ona ta přístupnost před těmi, řekněme, dvaceti lety byla opravdu postavena primárně pro cílovou skupinu uživatelů s nějakým zdravotním hendikepem, protože oni mají na tom webu největší problémy se někam dostat, pokud ten web není vytvořen s ohledem na nějaká pravidla přístupnosti. 
...
### Je to „přístupnost“, „inkluzivní design“ nebo „universal learning design“? {#inkluze}
...
Asi oba dva jsme četli publikaci od Heydona Pickeringa [Inclusive Design Patterns](https://www.smashingmagazine.com/inclusive-design-patterns/). A teď mě napadá, že on tu knížku vůbec neuvedl pojmem „Accessibility…“, ale že „vynalezl“ nový pojem. Asi aby se vyhnul tomu, že by to spadlo do kategorie: *„hele, to je pro ty odborníky na přístupnost, co se starají o ty slepé“*. Nnapsal to pro všechny a může si to koupit jakýkoliv designér a kodér.
...
### Jaké skupiny lidí přístupnost využijí a kolik stojí? {#skupiny}
...
### Nesmí se zapomenout na přístupnost dokumentů {#dokumenty}
...
### Co když šéfové přístupnost platit nechtějí? {#sefove}
...
### Přístupnost řešená po vzniku projektu {#pozde}
...
### Jak do toho konečně „šlápnout“? {#slapnout}
...
Ale třeba hodně mi pomáhá pustit si tu čtečku – ten [VoiceOver](https://www.apple.com/accessibility/mac/vision/) – na tom Macu a nechat si tu stránku opravdu přečíst... Minimálně ti to zobrazí, jestli máš dobře aspoň ty nadpisy, formuláře, jestli tam máš orientační body a jestli je tam máš dobře pojmenované... 
...
**Martin Michálek**: Děkuju všem, kteří nás poslouchali, a těším se na slyšenou u dalších epizod [podcastu ze Vzhůrudolů.cz](/podcast). Od mikrofonu se loučí Martin Michálek.