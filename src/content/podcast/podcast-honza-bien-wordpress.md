...
og_title: 'Podcast: S Honzou Bienem o WordPressu'
og_description: 'Honza je machr přes WordPress. A já zase svý způsobem hejtr tohodle redakčního systému. Co se stane, když se machr a hejtr potkají a natočí podcast?'
og_type: article
---
...
<p class="podcast">
Podcast: <a href="https://soundcloud.com/vzhurudolu/s-honzou-bienem-o-wordpressu" data-id="327568116">S Honzou Bienem o WordPressu</a>
</p>
...
* Proč Honza vůbec WordPress používá? ([text](#text-pouziva))
* Je WordPress pořád jen blogovátko? ([text](#text-blogovatko))
* WordPress versus Drupal z pohledu návrhu databáze ([text](#text-drupal))
* Jaké pluginy Honza používá a jak je vybírá? ([text](#text-pluginy))
* Jak řešit aktualizace? Dají se nějak zautomatizovat? ([text](#text-aktualizace))
* Není lepší klienty obsluhovat z jednoho online CMS? ([text](#text-online-cms))
* WordPress a frontend: Nedělá se s ním špatně? ([text](#text-frontend))
...
**JB:** Já teď kouzlím s WordPressem – zrovna chystám [jisté školení](http://www.vzhurudolu.cz/kurzy/wordpress) v rámci WordPressu, takže pronikám do jeho tajů stále hlouběji a hlouběji…
...
### Proč Honza vůbec WordPress používá? {#text-pouziva}
...
### Je WordPress pořád jen blogovátko? {#text-blogovatko}
...
### WordPress versus Drupal z pohledu návrhu databáze {#text-drupal}
...
### Jaké pluginy Honza používá a jak je vybírá? {#text-pluginy}
...
**JB:** Určitě používám nějaký cachovací plugin (když už jsme tady nakousli ten výkon) – to znamená cachovací na straně serveru. Aby každé to servírování stránky nebylo sestavování PHP, tak já používám [WP Super Cache](https://odd.blog/wp-super-cache/) (a je jich ještě několik dalších). Používám plugin pro zvýšení zabezpečení, to znamená ochranu proti brute force útokům... Používám nějaké debuggovací pluginy pro to, když něco ladím a potřebuji dohledat, kde se mi něco mění... Taky používám [Advanced Custom Fields](https://www.advancedcustomfields.com/) – to je úplně nerozšířenější, nejčastěji používaný plugin pro custom meta fieldy (tím si vytváříš tu vlastní strukturu, ty nody, které mají položky, které potřebuješ vyplňovat v tom redakčním systému). 

**MM:** Není pro tebe dost náročné sledovat ten ekosystém? Protože na cachování budou pluginů možná stovky, na bezpečnost taky... Není pro tebe dost pracné se v tom orientovat? Já jsem si minule povídal [s Riki Fridrichem o javascriptovém ekosystému](http://www.vzhurudolu.cz/blog/84-podcast-npm-yarn), který je úplně šílený a jde hrozně rychle dopředu... Předpokládám, že tady to tak rychle dopředu nepůjde, ale stejně tě to nějaký čas stojí...  
...
### Jak řešit aktualizace? Dají se nějak zautomatizovat? {#text-aktualizace}
...
**JB:** To je to, co říkám. To jsou ty nástroje [WP Remote](https://wpremote.com/) (to je něco, čím spravuješ aktualizace všech těch webů). Je to jedna aplikace, která se jmenuje [MainWP](https://mainwp.com/) – a je to WordPress, ze kterého spravuješ všechny WordPressy, se kterými si ho propojíš. WP Remote a [ManageWP](https://managewp.com/) jsou služby, u nichž z jednoho místa spravuješ všechny instance. 

### Není lepší klienty obsluhovat z jednoho online CMS? {#text-online-cms}
...
### WordPress a frontend: Nedělá se s ním frontendistům špatně? {#text-frontend}

**MM:** Další věc, která mě hodně zajímá (a také začnu předsudkem, který dneska mám vůči WordPressu) je práce s custom designem z pohledu frontenďáka. Když jsem si chtěl udělat vlastní design, tak si pamatuji, že mě WordPress dost věcí nutil dělat jinak, než jsem si představoval (dneska máš třeba workflow [s Gruntem](http://www.vzhurudolu.cz/prirucka/grunt), máš [preprocessory](http://www.vzhurudolu.cz/blog/12-css-preprocesory-1), chceš třeba spojovat, minifikovat a spoustu dalších věcí). Na frontendu je dost velká možnost kreativní práce – a mně přišlo, že ten WordPress tomu vůbec nejde naproti. Jak je to dneska? 
...
**MM:** Rádo se stalo, rád jsem tě viděl! A ještě než se rozloučíme, za poskytnutí útočiště pro nahrávání musím poděkovat firmě Maternia, která provozuje e-shop [VašeČočky.cz](https://www.vasecocky.cz/). Díky všem, co nás poslouchali. Těšíme se na slyšenou u dalších epizod podcastu ze VzhůruDolů.cz. Od mikrofonu se loučí Martin Michálek.