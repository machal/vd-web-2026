...
authorID: 1
sectionID: 1
og_title: 'Jaký byl rok 2015 ve webdesignu s důrazem na frontend kodéřinu'
og_description: 'Javascript, Adobe Comet, EU cookies, PostCSS, Google AMP… Málo toho nebylo!'
og_type: article
---

# Jaký byl rok 2015 ve webdesignu s důrazem na frontend kodéřinu

Javascript, Adobe Comet, EU cookies, PostCSS, Google AMP… [Pro newsletter](http://eepurl.com/D-SNv) jsme s Martinem Pešoutem vybrali témata, které stojí za pozornost a loni se buď nově objevila nebo výrazně posílila. 
...
React, Browserify, Webpack, CSS Modules… tohle všechno je skvělé. Pro webové aplikace. Pokud ale vyrábíte vyhledávačem indexovatelné statické weby, novinky javascriptového ekosystému až tak neoceníte. Potřebujete Javascript na serveru nebo totální závislost na frontendovém JS. Obojí je pro existující obsahové weby těžce zchůdné. 

Do budoucna je možné čekat, že současné webařské technologické ekosystémy (PHP, Rails…) převezmou leccos z aktuálního vývoje kolem Javascriptu. A ti co mohou, půjdou i u obsahových webů do izomorfního přístupu – JS na frontendu i backendu. 

Do té doby vězte, že za jQuery se u statických webů stydět nemusíte. Nástroje pro tvorbu webů a webových aplikací si nikdy nebyly dál a to jsme ještě neskončili.
...
… a taky Mobilegeddon, Service Worker, Physical Web nebo `navigator.connection`… kolem mobilních webů se toho loni dělo hodně! Více [v nedávném článku na Vzhůru dolů](/blog/45-2015-mobilni-web).
...
- *SVG* – vektorovou grafiku potřebujeme nejen kvůli „Retina displejům“. [SVG](/prirucka/svg) přináší i dlouhou řadu inovací do návrhu a implementace uživatelských rozhraní. Ještě o něm hodně uslyšíme.
...
<p class="text-small text-center margin-top-xl">
Článek původně vyšel v pravidelném měsíčním newsletteru. Pokud jej chcete dostávat mezi prvními, zanechte nám prosím svůj email:
</p>
