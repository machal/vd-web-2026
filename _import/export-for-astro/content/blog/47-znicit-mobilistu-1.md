---
postID: 47
postTitle: 'Jak zničit mobilní uživatele? Pomalým načítáním, karusely nebo schováním navigace'
postUrlId: znicit-mobilistu-1
postDateTime: 2016-01-13
excerpt: 'Zničit krtka, vydání 2016. Dnes si zahubíme uživatele mobilního webu. Postupujte podle mého návodu.'
...
og_title: 'Jak zničit mobilní uživatele? Pomalým načítáním, karusely nebo schováním navigace'
...
Teď ale chvíli vážně. Mobilní sítě jsou pomalé a ani postupné zvyšování přenosové rychlosti na 3G/4G sítích nikdy rychlost s pevným připojením nesrovná. Přitom stačí chtít a [na rychlost načítání myslet](/kurzy/rychlost-nacitani) už během přípravy webu. Testy a průzkumy totiž ukazují, že rychlost stránky má [velký vliv na konverze a úspěšnost webu](https://blog.kissmetrics.com/loading-time/). Uživatel by na vykreslení stránky neměl čekat více než jednotky vteřin ani na mobilním EDGE připojení.  

A nejde jen o mobily. Nezapomeňte, že rychlost načítání je [jedním z řadících parametrů](http://adwords.blogspot.cz/2008/06/landing-page-load-time-now-affects.html) pro výsledky vyhledávání Google nebo AdWords kampaní. Ovlivňuje tak nejen konverze, ale i pravděpodobnost, že se na web člověk vůbec dostane.

## 2) Dejte tam karusely, hodně karuselů

*… a uživatel se už nikdy nevrátí.* 

Karusely jsou komplikované a jejich využití potenciálně rizikové. Je pravda, že [studie jednoznačně neříkají](http://www.smashingmagazine.com/2015/02/carousel-usage-exploration-on-mobile-e-commerce-websites/), že by jejich použití bylo univerzálně nevhodné.  Je ale vysoce pravděpodobné, že použitím karuselu obsah uživatelům spíše skryjete, než abyste jej atraktivním způsobem prodali. 
...
Je jasné, že jakmile navigaci na mobilech schováte, [lidé ji přestanou používat](http://www.lukew.com/ff/entry.asp?1945). 

Pokud navigace říká návštěvníkovi něco důležitého a dokážete ji zobrazit celou, udělejte to. Pokud ji nedokážete zobrazit celou, zjednodušte její strukturu nebo [zobrazte alespoň důležité položky](http://jecas.cz/hamburger-menu). 

Nedokážete zobrazit ani důležité položky? Dobře, schovejte ji do ikonky hamburgeru [s popiskem „Menu“](http://exisweb.net/mobile-menu-abtest). Ale zajistěte, aby se web dal používat i bez navigace. 
...
Aktivní prvky by na dotykových displejích měly mít alespoň čtvereční centimetr. Ovládání palcem na chytrých telefonech je velmi nepřesné. Šikovnost a velikost prstu je také individuální. Obecně tedy platí [„čím větší aktivní plocha, tím lépe“](http://www.smashingmagazine.com/2012/02/21/finger-friendly-design-ideal-mobile-touchscreen-target-sizes/). 
...
HD displeje typu [Retina](https://www.apple.com/macbook-pro/features-retina/) nebo Amoled zvyšují jemnost rastru. Prvky stránky, které vykresluje prohlížeč (písmo, CSS styly), vypadají na těchto displejích výborně. Na druhou stranu – prvky, které dodává autor stránky (ikony, fotografie) tam mohou vypadat hůře, pokud pro ně grafika není připravená. [Může za to CSS pixel](/prirucka/css-pixel). Technická řešení nejsou složitá – zvažte použití [vektorového SVG](/prirucka/svg) nebo [responzivních obrázků](/prirucka/responzivni-obrazky) pro fotografie.
...
Uživatelům chytrých telefonů můžete velmi usnadnit kontakt s vámi, pokud zařídíte, aby telefonní číslo z webu sloužilo jako [odkaz pro otevření telefonního hovoru](http://www.mobilexweb.com/blog/click-to-call-links-mobile-browsers). Podobně je možné aktivovat Skype volání a na Apple zařízeních i FaceTime nebo odeslání SMS.
