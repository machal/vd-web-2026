...
sectionID: 1
no_ads: false
og_title: 'Podcast: S Vuem z Avocode o nástrojích mezi designéry a vývojáři'
og_description: 'Konec Photoshopu v Čechách? Pro webdesign snad už ano.'
og_type: article
---

# Podcast: S Vuem z Avocode o nástrojích mezi designéry a vývojáři
...
1. Vu říká, že Avocode řeší „strašně neefektivní workflow mezi designéry a vývojáři" ([text](#prepis-1))
2. Na menších nástrojích jako CSS Hat a dalších tým vydělal Milion dolarů.  Používalo je 200 tisíc vývojářů na celém světě. Ale je to už uzavřená kapitola  ([text](#prepis-2))
3. Nástroje pro návrh webů: Photoshop je pro webdesign z dlouhodobé perspektivy mrtvý, nahrazuje jej Sketch a Adobe XD  ([text](#prepis-3))
4. Adobe XD je rychlejší a má širší záběr než Sketch  ([text](#prepis-4))
5. Objevují se další nové zajímavé nástroje pro designéry: Figma nebo InVision Studio ([text](#prepis-5))
6. Neohrožuje pád Photoshopu právě Avocode? ([text](#prepis-6))
7. Avocode jako hub pro vývojáře  ([text](#prepis-7))
8. Konkurence: Zeplin, Sympli a InVision Inspect. Co si o ní Vu myslí? Čím se Avocode liší?  ([text](#prepis-8))
7. Integrace Avocode s editory kódu: vlastnost, kterou konkurence nemá  ([text](#prepis-9))
8. Systémy designu: Ano, jsou budoucnost a Avocode v nich vidí příležitost  ([text](#prepis-10))
9. Co plánují v nejbližší době? Upload Sketch souborů, Dropbox, zrychlení a další formáty jako Adobe XD  ([text](#prepis-11))
10. Nad dotazy čtenářů: Detaily ke vložené Sketche z Windows, integrace s Adobe XD, složitější efekty vrstev, integrace se Sublime Text  ([text](#prepis-12))
...
### Avocode řeší „strašně neefektivní workflow mezi designéry a vývojáři" {#prepis-1}
...
### Na menších nástrojích jako CSS Hat a dalších  nástrojích vydělali milion dolarů. Používalo je 200 tisíc vývojářů na celém světě. Ale je to už uzavřená kapitola  {#prepis-2}
...
Udělali jsme i nějakou hezkou kampaň (tweetoval to třeba i Smashing Magazine), nasbírali jsme strašně moc emailů (asi 16 tisíc) a na základě toho jsme vytvořili aspoň takový malý produkt na hackathonu, který se jmenoval [CSS Hat](https://csshat.com/). Byl to takový Photoshop plugin, který, když jste kliknuli na nějakou vrstvu, tak jste automaticky dostali CSS-ko k té vrstvě, to znamená, stíny, vytažení atd. To všechno bylo v tom CSS-ku automaticky a nemuseli jste to přepisovat, což bylo velké ušetření času pro toho vývojáře. 
...
Ten první opravdový, který jsme i začali prodávat a začali ho lidé reálně používat, byl ten CSS Hat. Když jsme to spustili, tak jsme vydělali 10 tisíc dolarů za prvních 24 hodin, bylo to [uvedeno i na Lupě](https://www.lupa.cz/clanky/enigma64-1000-licenci/). 
...
### Nástroje pro návrh webů: Photoshop je pro webdesign z dlouhodobé perspektivy mrtvý, nahrazuje jej Sketch a Adobe XD  {#prepis-3}
...
Myslím si, že nejen mě, ale i spoustu dalších lidí by zajímalo, jak to dneska s těmi nástroji vlastně je. Některé z nich jsi jmenoval – nové [Adobe XD](http://www.adobe.com/cz/products/xd.html), [Sketch](https://www.sketchapp.com/), [InVision](https://www.invisionapp.com/) a spoustu dalších věcí. Pojďme to tedy zkusit zmapovat... Co dnešní trh lidem nabízí? 
...
Já jsem si prostudoval vaši [statistiku vývoje nástrojů – Sketch vs. Photoshop](https://avocode.com/design-report-2016) – kde právě ten Photoshop hodně klesá a naopak získává Sketch, co se týká toho primárního grafického nástroje. Je Photoshop dlouhodobě „mrtvý"? 
...
Teď poslední dobou ještě moc nedesignuju, ale když ano, tak například svoje prezentace, různé pitch decky atd., a zkoušel jsme si i Sketch a musím říct, že nástroje uvnitř Sketche jsou mnohem lépe navržené pro designéry, co dělají UI a webdesign (např. konkrétně [symboly ve Sketchi jsou úžasné](https://sketchapp.com/docs/symbols/)). Když designuješ nějaký UI, tak se ti pořád opakují elementy. Ve Photoshopu musíš pořád duplikovat stejně, a vůbec to nemá žádnou logiku, vůbec to není propojené... 
...
### Adobe XD je rychlejší a má širší záběr než Sketch   {#prepis-4}
...
### Objevují se další nové zajímavé nástroje pro designéry: Figma nebo InVision Studio {#prepis-5}

**Vu**: Dost se do toho teď vmíchává [Figma](https://www.figma.com/), což je úplně stejný nástroj jako XD, akorát je postavená na webových technologiích. Mají webovou aplikaci, je to real time – více designérů může designovat jednu věc najednou, má to verzování. 

A [InVision Studio](https://www.invisionapp.com/studio). To je designový nástroj od InVision. Ten před dvěma lety koupil firmu, která se jmenovala [Macaw](http://macaw.co/), která taky sloužila k designování. A Macaw team udělal nové InVision studio, což je přímá konkurence XD, Sketche a Figmy. 
...
### Neohrožuje pád Photoshopu právě Avocode?  {#prepis-6}
...
Avocode je postaven tak, že je určen přímo jen pro vývojáře, máme dokonce integraci i [s e](https://atom.io/)[ditorem ](https://atom.io/)[Atom](https://atom.io/), a budeme pouštět i integraci [s Visual Studi](https://code.visualstudio.com/)[o](https://code.visualstudio.com/). Takže je to mnohem lépe postavené pro frontend vývojáře. Navíc my si myslíme, že čím víc těch designérský nástrojů je, tím složitější je pro vývojáře ty věci dostávat. Jinak je to ve Figmě, jinak je to ve Sketchi… 
...
### Avocode jako hub pro vývojáře {#prepis-7}
...
### Konkurence: Zeplin, Sympli a InVision Inspect. Co si o ní Vu myslí? Čím se Avocode liší?  {#prepis-8}

**Martin Michálek**: A co vaše konkurence? Vím akorát o tom, že existuje [Zeplin](https://zeplin.io/) a že InVision má nástroj, který jde trošku tímto směrem, ale nevím o nich vůbec nic... 
...
Ten prostor pořád roste, a proto mě těší, že máme konkurenci. Když bych měl srovnat nástroje pro předávání designu vývojářovi, to znamená Zeplin, [Sympli](https://sympli.io/) a [InVision Inspect](https://www.invisionapp.com/feature/inspect) – tak se jmenuje ta vlastnost uvnitř InVisionu. Oni mají ještě prototypování InVisionu, ale já bych se teď zaměřil hlavně na ten jejich Inspect.  Technologicky jsou ty jejich nástroje jsou dost podobné. 
...
### Integrace Avocode s editory kódu: vlastnost, kterou konkurence nemá  {#prepis-9}
...
**Vu**: Přesně tak. Zatím to děláme jedním směrem – z Avocodu do editoru, napovídáme snippety kódu a [máme i variables](https://avocode.zendesk.com/hc/en-us/articles/202090592-What-are-variables-and-replace-rules-in-Avocode-), které nahrazují proměnné v CSS-ku, to máme také uvnitř Avocodu. Všechno, co se napovídá do editoru kódu, to všechno se do Avocodu dostává automatizovaně, aniž by vývojář musel něco dělat.

### Systémy designu:  Ano, jsou budoucnost a Avocode v nich vidí příležitost   {#prepis-10}
...
* [Atomický design a Pattern Lab: návrat do budoucnosti návrhu uživatelských rozhraní](/prirucka/pattern-lab) 
</div>
...
### Nad dotazy čtenářů: Detaily ke vložené Sketche z Windows, integrace s Adobe XD, složitější efekty vrstev, integrace do Sublime Text {#prepis-12}
